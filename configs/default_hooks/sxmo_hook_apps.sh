...
write_line_app chromium "$icon_glb Chromium" "chromium"
write_line_app pinephone-compass "$icon_gps Compass" "pinephone-compass"
...
write_line_app snes9x-gtk "$icon_gam Snes9x" "snes9x-gtk"
...
write_line_app tubefeeder "$icon_ytb Tubefeeder" "tubefeeder"
